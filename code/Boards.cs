...
namespace 西洋跳棋
{
    public class Boards
    {
        ...
        public static int[,] boardState = new int[8, 8];      //模拟棋盘
        ...
        public static bool playerTurn = true;       //用于标记蓝(0)或红方(1)下棋

        public static bool winflag = false;   //胜负标志
